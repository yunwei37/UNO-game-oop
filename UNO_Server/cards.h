...
public:
    ...
    Card(COLOR color, CARD_TYPE cardType, int cardNum=-1) : color(color), cardType(cardType), cardNum(cardNum), cardId(count++){}
...
protected:
    ...
    const static Card allCards[108];
